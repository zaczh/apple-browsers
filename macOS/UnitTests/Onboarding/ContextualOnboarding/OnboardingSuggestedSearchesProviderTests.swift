...
class OnboardingSuggestedSearchesProviderTests: XCTestCase {
    ...
    func testSearchesListForEnglishLanguageAndUsRegion() {
        ...
        let expectedSearches = [
            ...
            ContextualOnboardingListItem.surprise(title: "https://duckduckgo.com/?q=baby+ducklings&ia=images&iax=images", visibleTitle: UserText.ContextualOnboarding.tryASearchOptionSurpriseMeTitle)
        ]
